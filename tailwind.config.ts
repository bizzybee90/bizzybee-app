...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        /* ── BizzyBee design system ── */
        bb: {
          espresso: 'var(--bb-espresso)',
          'espresso-80': 'var(--bb-espresso-80)',
          'espresso-60': 'var(--bb-espresso-60)',
          gold: 'var(--bb-gold)',
          'gold-light': 'var(--bb-gold-light)',
          'gold-border': 'var(--bb-gold-border)',
          linen: 'var(--bb-linen)',
          cream: 'var(--bb-cream)',
          white: 'var(--bb-white)',
          'warm-gray': 'var(--bb-warm-gray)',
          muted: 'var(--bb-muted)',
          ...
          neutral: 'var(--bb-neutral)',
          'neutral-bg': 'var(--bb-neutral-bg)',
        },
